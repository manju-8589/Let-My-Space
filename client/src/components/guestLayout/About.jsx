  ...
  return (
    <>
      <style>
        ...
        .about-section { 
          padding: 80px 0; 
          background: radial-gradient(circle at 10% 20%, rgb(226, 240, 254) 0%, rgb(196, 177, 174) 90%);  /* 
Gradient background */ 
          color: white; 
          opacity: 0; 
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(255, 255, 255, 0.1),rgba(255, 249, 91,0.1),#F4F8D3)",
            transition:"none",
        }}
      > 
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="section-title text-center" onMouseEnter={()=>setSize("220px")} onMouseLeave={()=>setSize("20px")}>
                <h2>About Us: Revolutionizing Rentals</h2>
                <p className="f-para" >
                  At LetMySpace, we make finding the perfect rental space
                  effortless. Whether you're looking for a home or a shop, we
                  connect you with the best options to fit your needs. Discover
                  a seamless renting experience and find your ideal space with
                  ease!
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="about-video">
                <iframe
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/h1ZQJpIvS_8?si=sIDM9IKF1MmCeISP"
                  title="YouTube video player"
                ></iframe>
              </div>
            </div>
            <div className="col-lg-6" onMouseEnter={()=>setSize("220px")} onMouseLeave={()=>setSize("20px")}>
              <div className="about-text" >
                <h3>Find Your Perfect Space with LetMySpace</h3>
                <p>
                  At LetMySpace, we understand that finding the right rental
                  property can be challenging. Our mission is simple: to make
                  renting homes and commercial spaces effortless and
                  stress-free. With a vast selection of verified listings, we
                  connect tenants with the perfect spaces to live and work.
                  Whether you're searching for a cozy apartment or a prime
                  commercial location, LetMySpace ensures a seamless and secure
                  renting experience. Join us in transforming the way people
                  find and rent properties!
                </p>
                <ul className="features-list">
                  <li>
                    <span className="icon_check">
                      <FaCircleCheck /> Seamless Space Booking
                    </span>
                  </li>
                  <li>
                    <span className="icon_check">
                      <FaCircleCheck /> Immersive Venue Experience
                    </span>
                  </li>
                  <li>
                    <span className="icon_check">
                      <FaCircleCheck /> Effortless Networking
                    </span>
                  </li>
                  <li>
                    <span className="icon_check">
                      <FaCircleCheck /> Premium Event Spaces
                    </span>
                  </li>
                </ul>
              </div>
